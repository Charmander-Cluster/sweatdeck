...
const EditCardioWorkout = () => {
  ...
  useEffect(() => {
    if (workoutAdded) {
      dispatch(createDBWorkoutNoPlaylist(cardioLocalWorkout, id));
      // history.push("/confirmcardiocreate")
      setRedirect(true);
    }
  }, [dispatch, workoutAdded, cardioLocalWorkout, id]);
  ...
  const handleChange = (event) => {
    setWorkout({ ...currentWorkout, [event.target.name]: event.target.value });
  };
  ...
  const handleNestedChange = (event) => {
    setExercises({ ...currentWorkout.exercises, [event.target.name]: event.target.value });
  };
                            ...
                            <div className="flex m-5 align-center">
                              <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                                ...
                                <input
                                  ...
                                  min="0"
                                  onChange={handleNestedChange}
                                  defaultValue={currentWorkout.exercises[0].distance}
                                />
                              </div>
                              ...
                              <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                                ...
                                <select
                                  ...
                                  name="units"
                                  required
                                  defaultValue={currentWorkout.exercises[0].units}
                                  onChange={handleNestedChange}
                                >
                            ...
                            <div className="container flex justify-center">
                              <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                ...
                                <input
                                  ...
                                  min="0"
                                  onChange={handleNestedChange}
                                  defaultValue={currentWorkout.exercises[0].hours}
                                />
                              </div>
                              ...
                              <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                ...
                                <input
                                  ...
                                  min="0"
                                  onChange={handleNestedChange}
                                  defaultValue={currentWorkout.exercises[0].minutes}
                                />
                              </div>
                            </div>
...
//         setRedirect(true);
//       }
//     }, [dispatch, workoutAdded, workout, id]);
...
//                             <div className="grid mt-5 place-items-center">
//                               <button
//                                 className="flex p-3 mb-3 text-base text-white bg-teal-500 rounded-md"
//                                 onClick={handleSubmitWithSpotify}
//                                 // href={AUTH_URL}
//                               >
//                                 Save as New & Add Playlist
//                               </button>

//                               <button
//                                 className="flex p-3 mb-3 text-base text-teal-500 border border-teal-500 rounded-md"
//                                 onClick={handleSubmitWithoutPlaylist}
//                               >
//                                 Save as New Without Playlist
//                               </button>
//                             </div>
//                           </div>
//                         </div>
